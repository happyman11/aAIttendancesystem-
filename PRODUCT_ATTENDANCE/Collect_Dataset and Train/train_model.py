...
from opencvutilityfunctions import *
...
def take_img():
    ...
    ID = txt.get()
    Name = txt2.get()
    sample_count=txt3.get()
    
    capture_frames(ID,Name,sample_count)        
        
    res = "Images Saved  : " + ID + " Name : " + Name
    Notification.configure(text=res, bg="SpringGreen3", width=50, font=('times', 18, 'bold'))
    Notification.place(x=250, y=500)
...
lbl3 = tk.Label(window, text="Sample Count", width=20, fg="black",  height=2, font=('times', 20, 'italic bold '))
lbl3.place(x=200, y=400)

txt3 = tk.Entry(window, width=20, fg="red")
